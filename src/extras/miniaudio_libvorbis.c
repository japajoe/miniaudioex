...
MA_API ma_result ma_libvorbis_init_file_w(const wchar_t* pFilePath, const ma_decoding_backend_config* pConfig, const ma_allocation_callbacks* pAllocationCallbacks, ma_libvorbis* pVorbis)
{
    ma_result result;
    ...
    #if !defined(MA_NO_LIBVORBIS)
    {
        ...
        libvorbisResult = ov_wfopen(pFilePath, (OggVorbis_File*)pVorbis->vf);
        if (libvorbisResult < 0) {
            return MA_INVALID_FILE;
        }
...
MA_API ma_result ma_libvorbis_init_memory(void* pData, ma_uint64 dataSize, const ma_decoding_backend_config* pConfig, const ma_allocation_callbacks* pAllocationCallbacks, ma_libvorbis* pVorbis)
{
    ma_result result;
    ...
    #if !defined(MA_NO_LIBVORBIS)
    {
        ...
        libvorbisResult = ov_mopen(pData, dataSize, (OggVorbis_File*)pVorbis->vf);
...
static ma_result ma_decoding_backend_init_file_w__libvorbis(void* pUserData, const wchar_t* pFilePath, const ma_decoding_backend_config* pConfig, const ma_allocation_callbacks* pAllocationCallbacks, ma_data_source** ppBackend)
{
    ma_result result;
    ma_libvorbis* pVorbis;
    ...
    result = ma_libvorbis_init_file_w(pFilePath, pConfig, pAllocationCallbacks, pVorbis);
    if (result != MA_SUCCESS) {
        ma_free(pVorbis, pAllocationCallbacks);
        return result;
    }
...
static ma_result ma_decoding_backend_init_memory__libvorbis(void* pUserData, const void* pData, size_t dataSize, const ma_decoding_backend_config* pConfig, const ma_allocation_callbacks* pAllocationCallbacks, ma_data_source** ppBackend)
{
    ...
    result = ma_libvorbis_init_memory((void*)pData, dataSize, pConfig, pAllocationCallbacks, pVorbis);
    if (result != MA_SUCCESS) {
        ma_free(pVorbis, pAllocationCallbacks);
        return result;
    }
...
static ma_decoding_backend_vtable ma_gDecodingBackendVTable_libvorbis =
{
    ...
    ma_decoding_backend_init_file_w__libvorbis, /* onInitFileW() */
    ma_decoding_backend_init_memory__libvorbis, /* onInitMemory() */
    ma_decoding_backend_uninit__libvorbis
};

MA_API ma_decoding_backend_vtable *ma_libvorbis_get_decoding_backend(void) {
